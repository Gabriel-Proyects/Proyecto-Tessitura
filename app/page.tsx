...
export default function HomePage() {
  ...
  const heroImages = ["/1.jpg", "/2.jpeg", "/3.jpg", "/4.jpeg", "/5.jpg"]
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-10">
            <RevealOnScroll className="text-center">
              <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-amber-400 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                <i className="fas fa-calendar-alt text-xl sm:text-2xl text-black"></i>
              </div>
              <h3 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-2">15+</h3>
              <p className="text-sm sm:text-base text-gray-300">Años de Experiencia</p>
            </RevealOnScroll>

            <RevealOnScroll className="text-center">
              <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-amber-400 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                <i className="fas fa-building text-xl sm:text-2xl text-black"></i>
              </div>
              <h3 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-2">200+</h3>
              <p className="text-sm sm:text-base text-gray-300">Proyectos Completados</p>
            </RevealOnScroll>

            <RevealOnScroll className="text-center">
              <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-amber-400 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                <i className="fas fa-users text-xl sm:text-2xl text-black"></i>
              </div>
              <h3 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-2">150+</h3>
              <p className="text-sm sm:text-base text-gray-300">Clientes Satisfechos</p>
            </RevealOnScroll>

            <RevealOnScroll className="text-center">
              <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-amber-400 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                <i className="fas fa-award text-xl sm:text-2xl text-black"></i>
              </div>
              <h3 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-2">25+</h3>
              <p className="text-sm sm:text-base text-gray-300">Reconocimientos</p>
            </RevealOnScroll>
          </div>
        </div>
      </section>

      <section id="about-us" className="relative py-12 sm:py-16 lg:py-20 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-white mb-4 sm:mb-6 drop-shadow-lg">
              Quiénes Somos
            </h2>
          ...
          <RevealOnScroll>
            <div className="max-w-4xl mx-auto bg-white/95 backdrop-blur-sm p-6 sm:p-8 lg:p-10 rounded-2xl shadow-2xl border-l-4 border-amber-400">
              <div className="flex flex-col sm:flex-row items-start sm:items-center mb-6 gap-4">
                <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-black rounded-full flex items-center justify-center flex-shrink-0">
                  <i className="fas fa-building text-xl sm:text-2xl text-amber-400"></i>
                </div>
                <h3 className="text-2xl sm:text-3xl font-bold text-black">TESSITURA ARQUITECTOS</h3>
              </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {[
              ...
              },
              {
                ...
                image: "/proyectos/consultoria.jpg",
              },
            ].map((project, index) => (
